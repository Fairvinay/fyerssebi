...
import PositionGridDraggable from '../positionGrid/PositionGridDraggable';
import PositionGridResizeDraggable from '../positionGrid/PositionGridResizeDraggable';
import PositionGridResizeDraggableMobile from '../positionGrid/PositionGridResizeDraggableMobile';
            ...
            <div
                className={handleCustomGridCols(tab)}>
                {
                    tab === "Educate" ? gainers.map((item: any , index: number ) => {
                     ...
                     ) :  tab === "Position" ?   (  <>   <PositionGrid positionDataB={positionData} />
                          {/* 
                          <PositionGridResizeDraggableMobile positionDataB={positionData} /> 
                                <PositionGridDraggable positionDataB={positionData} /> 
                          */} </>
