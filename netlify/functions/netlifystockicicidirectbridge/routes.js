...
var redirectUrl  = 'https://fyersbook.netlify.app/.netlify/functions/netlifyupstoxbridge/api/upstoxcallback';
//"https://fyersbook.netlify.app/.netlify/functions/netlifystockfyersbridge/api/fyersauthcodeverify"
...
// REDIRECT URI PROVIDED by US ONLY https://fyersbook.netlify.app/.netlify/functions/netlifystockicicidirectbridge/api/icicidirectauthcodeverify
    ...
    try {
       ...
       /* This is not required JUST send the session token
			...
			ejs.renderFile(path.join(__dirname, "views/icici_customer_template.ejs"),
                ...
                posturl:"https://fyersbook.netlify.app/.netlify/functions/netlifystockicicidirectbridge/api"
				})
				.then(result => {
...
router.get('/upstoxsdkcallback', async function (req,res) {
    ...
    try {
        ...
        let redirectUrlInternal = 'https://fyersbook.netlify.app/.netlify/functions/netlifyupstoxbridge/api/upstoxcallback';
        //res.send(output)
        /*
...
async function handledUpstoxRedirectAuthCode(authcode, req , res ){
  ...
  try {
      ...
      let your_redirect_url = 'https://fyersbook.netlify.app/.netlify/functions/netlifyupstoxbridge/api/upstoxcallback';
